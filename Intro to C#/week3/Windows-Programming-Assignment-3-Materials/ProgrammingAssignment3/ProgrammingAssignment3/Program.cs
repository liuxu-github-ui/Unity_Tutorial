    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (input[0] != 'q')
            {
                ...
                if (number % 2 == 0)
                {
                    // I know that even tough you asked me to print if the number is even or odd and then print if it's negative or positive, this was the way I found to print both in the same line
                    if (number > 0)
                    {
