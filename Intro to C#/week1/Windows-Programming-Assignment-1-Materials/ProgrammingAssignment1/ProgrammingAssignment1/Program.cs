    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (input[0] != 'q')
            {
                ...
                float xDifference = (point2X - point1X);
                float yDifference = (point2Y - point1Y);


                double angle =(double) Math.Atan2(yDifference,xDifference) * 180 / Math.PI;
                
                Console.WriteLine(Math.Round(Math.Sqrt(xDifference*xDifference + yDifference*yDifference),6) + " " + angle.ToString());
